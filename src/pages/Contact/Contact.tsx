...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-4 py-8 md:px-8 lg:px-12">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4 text-slate-300">
                ...
                <div>
                  ...
                  <p className="text-slate-400">morenomatthew83@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 text-slate-300">
                ...
                <div>
                  ...
                  <p className="text-slate-400">Email or LinkedIn</p>
                </div>
              </div>
            </div>
          </div>
